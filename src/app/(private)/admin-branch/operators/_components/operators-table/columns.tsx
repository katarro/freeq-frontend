      ...
      return (
        <div className="flex items-center gap-2">
          <div>
            ...
            {operator.startDate && (
              <div className="text-sm text-muted-foreground">Desde {operator.startDate}</div>
            )}
          </div>
        </div>
      );
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex flex-col">
          ...
          {operator.phone && (
            <div className="text-sm text-muted-foreground">+ {operator.phone}</div>
          )}
        </div>
      );
    },
    ...
    cell: ({ row, table }) => {
      ...
      return (
        <div className="flex items-center justify-center space-x-2">
          <abbr title="Editar">
            <Link
              href={`/admin-branch/operators/edit/${operator.id}`}
              className={cn(
