...
import OverviewChart from '@/app/(private)/admin-branch/kpis/_components/overview-chart';
...
import { branchData } from '@/app/(private)/admin-branch/kpis/data';
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className='space-y-4'>
                      {[
                        {
                          action: 'Nuevo gerente de sucursal asignado',
                          branch: 'Santiago Centro',
                          time: 'hace 2 horas',
                        },
                        {
                          action: 'Mantenimiento del sistema completado',
                          branch: 'Todas las sucursales',
                          time: 'hace 4 horas',
                        },
                        {
                          action: 'Resultados de la encuesta actualizados',
                          branch: 'Providencia',
                          time: 'hace 6 horas',
                        },
                        {
                          action: 'Nuevo ejecutivo añadido',
                          branch: 'Las Condes',
                          time: 'hace 8 horas',
                        },
                      ].map((activity, i) => (
          ...
          {activeTab === 'performance' && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Comparación del tiempo de servicio
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className='space-y-4'>
                      ...
                      <div className='w-full'>
                        ...
                        <div className='flex justify-end mt-1'>
                          <span className='text-xs text-muted-foreground'>
                            Satisfacción: {branch.satisfaction}
                          </span>
                        </div>
                      </div>
                    </div>
          ...
          {activeTab === 'table' && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Métricas detalladas de rendimiento para todas las sucursales
                </CardDescription>
              </CardHeader>
                          ...
                          <TableCell>
                            <Badge
                              ...
                              className={`
                                ...
                                ${
                                  branch.satisfaction >= 80 &&
                                  branch.satisfaction < 90
