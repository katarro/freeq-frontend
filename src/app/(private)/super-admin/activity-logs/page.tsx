...
const activityLogsData: ActivityLogValues[] = [
  ...
  },
  {
    ...
    details: 'Actualización de parámetros de sucursal',
    ip: '192.168.1.2',
    level: 'Info',
  },
  {
    date: '15/05/2025',
    time: '19:30:45',
    user: 'jefe@sucursal.com',
    action: 'Creación',
    details: 'Creación de nuevo ejecutivo',
    ip: '192.168.1.3',
    level: 'Info',
  },
  {
    ...
    user: 'sistema',
    action: 'Error',
    details: 'Error en la conexión con el servicio de notificaciones',
    ip: '192.168.1.4',
    level: 'Error',
  },
  {
    ...
    user: 'superadmin@freeq.com',
    action: 'Eliminación',
    details: 'Eliminación de empresa inactiva',
    ip: '192.168.1.1',
    level: 'Warning',
  },
  {
    ...
    user: 'admin@empresa.com',
    action: 'Actualización',
    details: 'Actualización de datos de empresa',
    ip: '192.168.1.2',
    level: 'Info',
  },
  {
    ...
    details: 'Cambio en reglas de fila',
    ip: '192.168.1.3',
    level: 'Info',
  },
  {
  ...
  },
  {
    ...
    user: 'superadmin@freeq.com',
    action: 'Creación',
    details: 'Creación de nueva empresa',
    ip: '192.168.1.1',
    level: 'Info',
  },
];
