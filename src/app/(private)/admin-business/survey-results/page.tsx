...
export default function SurveyResultsPage() {
  ...
  const [currentOperator, setCurrentOperator] = useState<OperatorValues | null>(
    null,
  );
      ...
      <section className='grid gap-4'>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                {operatorSurveyResults.reduce(
                  (sum, op) => sum + (op.totalResponses ?? 0),
                  0,
                )}
              </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Análisis de satisfacción y rendimiento individual
            </CardDescription>
          </CardHeader>
          <CardContent>
            <SurveyResultsTable
        ...
        <div className='grid gap-4 md:grid-cols-2'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Rendimiento comparativo del equipo
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <Card>
                    ...
                    <CardContent className='space-y-3'>
                      ...
                      <div className='flex justify-between'>
                        ...
                        <span>
                          {currentOperator?.details?.averageServiceTime}
                        </span>
                      </div>
                      <div className='flex justify-between'>
                        <span className='text-muted-foreground'>
                    ...
                    <CardContent className='space-y-3'>
                      <div>
                        ...
                        <div className='flex flex-wrap gap-1 mt-1'>
                          {currentOperator?.details?.languages?.map(
                            (lang, index) => (
                      ...
                      <div>
                        ...
                        <div className='flex flex-wrap gap-1 mt-1'>
                          {currentOperator?.details?.certifications?.map(
                            (cert, index) => (
                    ...
                    <CardContent className='pt-4'>
                      <div className='text-center'>
                        <p className='text-xl font-bold text-green-600'>
                          {currentOperator.recentComments?.filter(
                            (c) => c.rating >= 4,
                          ).length ?? 0}
                        </p>
                        <p className='text-xs text-muted-foreground'>
                ...
                <Card>
                  ...
                  <CardContent>
                    <ScrollArea className='h-96'>
                      <div className='space-y-4'>
                        {currentOperator.recentComments?.map(
                          (comment, index) => (
                            <div key={index} className='border rounded-lg p-4'>
                              <div className='flex items-start justify-between mb-2'>
                                <div className='flex items-center gap-2'>
                        ...
                        <BarChart
                          data={Object.entries(
                            ...
                            promedio: Math.round(
                              ...
                              /*@ts-expect-error*/
                              operatorSurveyResults.reduce(
                                (sum, op) => sum + (op?.categories?.[key] || 0),
                                0,
                              ) / operatorSurveyResults.length,
                            ),
                          }))}
