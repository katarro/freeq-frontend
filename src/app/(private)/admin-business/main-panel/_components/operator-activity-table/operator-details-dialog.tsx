      ...
      <DialogContent className='max-w-2xl'>
        <DialogHeader>
          <DialogTitle className='leading-relaxed'>
            Detalles del operador <br /> {operator?.name}
          </DialogTitle>
          <DialogDescription>
            Información detallada y métricas de rendimiento
          </DialogDescription>
        </DialogHeader>
        {operator && (
              ...
              <div className='space-y-2'>
                ...
                <div className='space-y-1 text-sm'>
                  ...
                  <p>
                    ...
                    {operator.currentClient || 'Ninguno'}
                  </p>
                </div>
              </div>
              <div className='space-y-2'>
            ...
            <div className='space-y-2'>
              ...
              <div className='p-3 bg-muted rounded-lg'>
                ...
                {operator.currentClient && operator.timeWithClient && (
                  <p className='text-sm'>
                    <strong>Tiempo con cliente actual:</strong>{' '}
                    {operator.timeWithClient}
                  </p>
                )}
              </div>
            </div>
