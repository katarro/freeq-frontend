...
import SurveyResultsTable from '@/app/(private)/subsidiary-manager/survey-results/_components/survey-results-table';
        ...
        <div className="grid gap-4 grid-cols-2 md:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {Math.round(
                  operatorSurveyResults.reduce((sum, op) => sum + (op.averageSatisfaction ?? 0), 0) /
        ...
        <Sheet open={detailsDialogOpen} onOpenChange={setDetailsDialogOpen}>
          <SheetContent side="bottom" className="h-[90vh] overflow-y-auto">
            <SheetHeader>
              ...
              <SheetDescription>Información completa del operador y métricas de rendimiento</SheetDescription>
            </SheetHeader>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-green-600">{currentOperator?.details?.resolutionRate}%</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Tasa de escalación:</span>
                        <span className="text-red-600">{currentOperator?.details?.escalationRate}%</span>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="space-y-2">
                          {Object.entries(currentOperator?.categories || {}).map(([category, value]) => (
        ...
        <Dialog open={detailsDialogOpen} onOpenChange={setDetailsDialogOpen}>
          <DialogContent className="w-[80vw] !max-w-full  max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>Información completa del operador y métricas de rendimiento</DialogDescription>
            </DialogHeader>
        ...
        <Sheet open={commentsDialogOpen} onOpenChange={setCommentsDialogOpen}>
          <SheetContent side="bottom" className="h-[90vh] overflow-y-auto">
            <SheetHeader>
              ...
              <SheetDescription>Feedback detallado de los clientes sobre la atención recibida</SheetDescription>
            </SheetHeader>
        ...
        <Dialog open={commentsDialogOpen} onOpenChange={setCommentsDialogOpen}>
          <DialogContent className="w-[80vw] !max-w-full max-h-[90vh]">
            <DialogHeader>
              ...
              <DialogDescription>Feedback detallado de los clientes sobre la atención recibida</DialogDescription>
            </DialogHeader>
        ...
        <Sheet open={chartsDialogOpen} onOpenChange={setChartsDialogOpen}>
          <SheetContent side="bottom" className="h-[90vh] overflow-y-auto">
            <SheetHeader>
              ...
              <SheetDescription>Visualización completa del rendimiento y tendencias</SheetDescription>
            </SheetHeader>
                    ...
                    <CardContent>
                      <ResponsiveContainer width="100%" height={250}>
                        <LineChart data={currentOperator.weeklyData}>
                          ...
                          <YAxis domain={[80, 100]} />
                          <Tooltip />
                          <Line type="monotone" dataKey="satisfaction" stroke="#0194ad" strokeWidth={3} />
                        </LineChart>
                      </ResponsiveContainer>
                    </CardContent>
                  </Card>
                ...
                <TabsContent value="categories" className="space-y-4">
                  <Card>
                    ...
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
                        <RadarChart
                          data={Object.entries(currentOperator?.categories || {}).map(([key, value]) => ({
                            category: key,
                            value: value || 0,
                            fullMark: 100,
                          }))}
                        >
                          ...
                          <Radar dataKey="value" stroke="#0194ad" fill="#0194ad" fillOpacity={0.3} />
                        </RadarChart>
                      </ResponsiveContainer>
                    </CardContent>
                  </Card>
                      ...
                      <ResponsiveContainer width="100%" height={300}>
                        <BarChart
                          data={Object.entries(currentOperator.categories || {}).map(([key, value]) => ({
                            ...
                            operador: value || 0,
                            promedio: Math.round(
                              operatorSurveyResults.reduce((sum, op) => sum + ((op?.categories as Record<string, number | undefined>)?.[key] ?? 0), 0) /
                              operatorSurveyResults.length,
                            ),
                          }))}
                        >
        ...
        <Dialog open={chartsDialogOpen} onOpenChange={setChartsDialogOpen}>
          <DialogContent className="w-[80vw] !max-w-full max-h-[90vh]">
            <DialogHeader>
              ...
              <DialogDescription>Visualización completa del rendimiento y tendencias</DialogDescription>
            </DialogHeader>
                      ...
                      <CardContent>
                        <ResponsiveContainer width="100%" height={300}>
                          <LineChart data={currentOperator.weeklyData}>
                            ...
                            <Tooltip />
                            <Line type="monotone" dataKey="satisfaction" stroke="#0194ad" strokeWidth={3} />
                            <Line type="monotone" dataKey="responses" stroke="#35ad77" strokeWidth={2} />
                          </LineChart>
                        </ResponsiveContainer>
                      </CardContent>
                    </Card>
                        ...
                        <BarChart
                          data={Object.entries(currentOperator.categories || {}).map(([key, value]) => ({
                            ...
                            promedio: Math.round(
                              ...
                              /*@ts-expect-error*/
                              operatorSurveyResults.reduce((sum, op) => sum + (op?.categories?.[key] || 0), 0) /
                              operatorSurveyResults.length,
                            ),
                          }))}
                        >
