  ...
  <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
    <div
      className={cn(
        ...
        demandLevel === 'Baja' && 'bg-gradient-to-r from-green-400 to-green-500 w-1/3',
        demandLevel === 'Media' && 'bg-gradient-to-r from-yellow-400 to-yellow-500 w-2/3',
        demandLevel === 'Alta' && 'bg-gradient-to-r from-red-400 to-red-500 w-full',
      )}
    ></div>
  </div>
);
  ...
  <div className="flex-1 flex justify-center">
    <div className="text-center space-y-3">
      <div className="relative">
        <p className="font-black text-5xl text-primary mb-1">{currentPeopleInQueue}</p>
      </div>
      <p className="text-gray-600 font-medium">
        {currentPeopleInQueue === 1 ? 'Persona esperando' : 'Personas esperando'}
      </p>
...
export default function ServicesPage() {
  ...
  const companyStatus = company.isActive ? SiteStatus.AVAILABLE : SiteStatus.CLOSED;
    ...
    <>
      ...
      <section className="px-4 py-5 flex flex-col gap-6 container max-w-[600px] mx-auto">
        <div className="text-center space-y-4 mb-6">
          <div className="relative">
            <h1 className="text-2xl font-bold text-heading-foreground mb-2">{queue.name}</h1>
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-2xl p-6 shadow-lg backdrop-blur-sm">
          ...
          {queue.isActive ? (
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
              <p className="text-gray-500 font-medium">🔒 Esta cola está temporalmente cerrada</p>
