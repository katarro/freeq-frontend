...
export function QueueList({ company, queues }: ServicesListProps) {
  ...
  useEffect(() => {
    console.log(
      queues.map((queue) => {
        console.log(queue.estimatedWaitTimeMinutes);
      }),
    );
  }, []);
    ...
    <>
      {company.isActive ? (
            ...
            >
              ...
              <div className="p-4">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    <h3 className="font-medium text-heading-foreground mb-1">{queue.name}</h3>
              ...
              <div
                ...
                className={cn(
                  ...
                  queue.demandLevel === 'Media' && 'bg-yellow-50 text-yellow-700',
        ...
        <div className="text-center py-8">
          <p className="text-gray-600">Esta empresa está cerrada actualmente.</p>
          <p className="text-sm text-gray-500 mt-2">Los servicios no están disponibles.</p>
        </div>
      )}
    </>
  );
