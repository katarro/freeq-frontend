...
export function BranchesList({
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {branches.map((branch) => (
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <h3 className="font-medium text-heading-foreground mb-1">{branch.name}</h3>
  ...
  return (
    <div className="text-center py-8">
      <p className="text-gray-600">No hay sucursales disponibles para esta empresa.</p>
      <p className="text-sm text-gray-500 mt-2">Inténtalo de nuevo más tarde.</p>
    </div>
  );
}
